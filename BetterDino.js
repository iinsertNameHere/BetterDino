...
"document.getElementById('sps').innerText = speed" +
"console.log('Changed Speed');" +
"}" +
"function resetspeed(){" +
"Runner.instance_.setSpeed(Runner.instance_.oSpeed);" +
"document.getElementById('sps').innerText = 'Normal'" +
...
"<p>GodMode: <p id='gms' style='color: blue'>Off</p></p>" +
"<p>Speed: <p id='sps' style='color: blue'>Normal</p></p>" +
"</div>");
